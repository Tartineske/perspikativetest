...
(function () {
  ...
  LiquidGlass.prototype._applyFilter = function () {
    ...
    const value = `url(#${this.filterId}) blur(2px) contrast(0.96) saturate(1.06)`;
  ...
  const LIQUID_GLASS_TARGETS = [
    ...
    { selector: '.search-float-btn', shape: 'circle', bezel: 10, maxShift: 3 },
    { selector: '.lightbox-window', shape: 'pill', bezel: 30, maxShift: 20 },
  ];
